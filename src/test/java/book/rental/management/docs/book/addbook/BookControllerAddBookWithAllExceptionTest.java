...
public class BookControllerAddBookWithAllExceptionTest extends RestDocSupport {

    @Test
    @DisplayName("[DOCS] 책 등록 시 '제목', '저자', '출판사'를 모두 입력하지 않으면 '400' 오류가 발생한다.")
    void addBook_Exception() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/v1/book")
                ...
                .andDo(document("add-Book-required-with-all-exception",
