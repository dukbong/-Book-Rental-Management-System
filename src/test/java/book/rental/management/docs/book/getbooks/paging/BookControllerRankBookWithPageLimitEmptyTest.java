...
public class BookControllerRankBookWithPageLimitEmptyTest extends RestDocSupport {

    @Test
    @DisplayName("[페이징 - limit: null] 대여한 횟수로 책의 순위를 매길 수 있다.")
    void rankBook() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/v1/book/rank")
                ...
                .andDo(document("rank-book-paging-param-empty-limit",
