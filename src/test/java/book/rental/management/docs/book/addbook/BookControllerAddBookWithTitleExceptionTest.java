...
public class BookControllerAddBookWithTitleExceptionTest extends RestDocSupport {

    @Test
    @DisplayName("[DOCS] 책 등록 시 '제목'을 입력하지 않으면 '400' 오류가 발생한다.")
    void addBook_Exception() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/v1/book")
                ...
                .andDo(document("add-Book-required-with-title-exception",
