...
public class MemberControllerAddMemberTest extends RestDocSupport {

    @Test
    @DisplayName("[DOCS] 사용자를 등록할 수 있다.")
    void addMember() throws Exception {
        // given
        JoinMemberRequest request = new JoinMemberRequest("James Arthur Gosling", "java@gmail.com", "010-1111-1111");
