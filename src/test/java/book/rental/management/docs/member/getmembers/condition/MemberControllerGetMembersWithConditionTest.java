...
public class MemberControllerGetMembersWithConditionTest extends RestDocSupport {
    @Test
    ...
    void getMembersWithCondition() throws Exception {
        ...
        MemberCondition condition = new MemberCondition("James Arthur Gosling", null, "");
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/v1/members/search")
                        .param("name", "James Arthur Gosling")
                        .param("phoneNumber", "")
