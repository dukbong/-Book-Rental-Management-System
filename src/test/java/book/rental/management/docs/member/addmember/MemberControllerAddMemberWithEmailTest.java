...
public class MemberControllerAddMemberWithEmailTest extends RestDocSupport {

    @Test
    @DisplayName("[DOCS] 사용자는 이메일 없이도 등록할 수 있다.")
    void addMember() throws Exception {
        // given
        JoinMemberRequest request = new JoinMemberRequest("James Arthur Gosling", null, "010-1111-1111");
        ...
        mvc.perform(MockMvcRequestBuilders.post("/api/v1/member")
                ...
                .andDo(document("add-member-null-email",
