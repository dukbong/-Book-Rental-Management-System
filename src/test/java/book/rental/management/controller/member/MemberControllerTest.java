...
class MemberControllerTest extends ControllerTestSupport {
    ...
    class addMemberTests {
        ...
        void addMember() throws Exception {
            ...
            JoinMemberRequest joinMemberRequest = new JoinMemberRequest("test1", "test1@gmail.com", "010-1111-1111");
            AddMemberResponse response = new AddMemberResponse(memberId);

            // when
            when(memberService.addMember(joinMemberRequest)).thenReturn(response);
    ...
    class validationTests {
        ...
        void addMemberWithValidation_name() throws Exception {
            // given
            JoinMemberRequest joinMemberRequest = new JoinMemberRequest("", "test1@gmail.com", "010-1111-1111");
        ...
        void addMemberWithValidation_email() throws Exception {
            // given
            JoinMemberRequest joinMemberRequest = new JoinMemberRequest("test1", "test1123123", "010-1111-1111");
        ...
        void addMemberWithValidation_phoneNumber() throws Exception {
            // given
            JoinMemberRequest joinMemberRequest = new JoinMemberRequest("test1", "test1@gmail.com", "0101111112431");
        ...
        void addMemberWithValidation_All() throws Exception {
            // given
            JoinMemberRequest joinMemberRequest = new JoinMemberRequest("", "test1234", "0101111112431");
